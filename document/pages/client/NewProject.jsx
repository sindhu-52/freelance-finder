...
const NewProject = () => {
    ...
    const handleSubmit = async() =>{
      await axios.post("http://localhost:5000/new-project", {title, description, budget, skills, clientId: localStorage.getItem('userId'),  clientName: localStorage.getItem('username'),  clientEmail: localStorage.getItem('email')}).then(
        (response)=>{
