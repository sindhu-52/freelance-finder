...
// // mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/Freelancing'
...
// inside your route:
const freelancerData = await Freelancer.findOne({ userId:new mongoose.Types.ObjectId(freelancerId) });
...
const freelancerFunds = parseInt(freelancer.funds || 0);
const projectBudget = parseInt(project.budget || 0);

freelancer.funds = freelancerFunds + projectBudget;
...
res.status(200).json({ _id, username, email, usertype });
